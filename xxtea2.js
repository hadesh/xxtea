...
function encryptToBase64(data, key) {
    return Base64.encode64(encrypt(data, key));
}
...
function decryptFromBase64(data, key) {
    ...
    return decrypt(Base64.decode64(data), key);
}
...
module.exports = Object.create(null, {
    xxtea_encrypt: { value: encryptToBase64 },
    xxtea_decrypt: { value: decryptFromBase64 },
    encode64: {value: encode64},
    decode64: {value: decode64},
});